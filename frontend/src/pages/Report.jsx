...
const styles = {
  ...
  title: { fontSize: '32px', fontWeight: '800', color: '#0f172a' },
  titleMobile: { fontSize: '26px' },
  homeBtn: { background: 'linear-gradient(135deg, #6366f1, #7c3aed)', border: 'none', color: 'white', padding: '10px 20px', borderRadius: '8px', cursor: 'pointer', fontWeight: '600', boxShadow: '3px 3px 0 rgba(79,70,229,0.22)' },
  backBtn: { background: '#fff', borderTop: '2px solid rgba(255,255,255,0.95)', borderLeft: '2px solid rgba(255,255,255,0.85)', borderBottom: '2px solid rgba(99,102,241,0.18)', borderRight: '2px solid rgba(99,102,241,0.12)', color: '#0f172a', padding: '10px 20px', borderRadius: '8px', cursor: 'pointer', fontWeight: '600', boxShadow: '2px 2px 0 rgba(99,102,241,0.09)' },
  ...
  scoreNum: { fontSize: '40px', fontWeight: '800', lineHeight: 1, color: '#0f172a' },
  scoreMax: { color: '#64748b', fontSize: '14px' },
  perfLevel: { fontSize: '20px', fontWeight: '700', color: '#6366f1' },
  detailsCard: { padding: '32px' },
  detailsCardMobile: { padding: '20px' },
  sectionTitle: { fontSize: '18px', fontWeight: '800', marginBottom: '24px', color: '#0f172a' },
  ...
  dLabel: { color: '#64748b', fontSize: '13px', textTransform: 'uppercase', fontWeight: '600' },
  dVal: { fontSize: '16px', fontWeight: '600', color: '#0f172a' },
  metricsCard: { padding: '32px', marginBottom: '24px' },
  barGrid: { display: 'grid', gap: '20px' },
  barLabelGroup: { display: 'flex', justifyContent: 'space-between', marginBottom: '8px', fontSize: '14px', fontWeight: '700', color: '#0f172a' },
  barBg: { height: '10px', background: '#e0e7ff', borderRadius: '5px', overflow: 'hidden', borderTop: '1px solid rgba(255,255,255,0.8)', borderLeft: '1px solid rgba(255,255,255,0.7)', borderBottom: '1px solid rgba(99,102,241,0.15)', borderRight: '1px solid rgba(99,102,241,0.1)' },
  barFill: { height: '100%', background: 'linear-gradient(90deg, #6366f1, #a855f7)', borderRadius: '5px', boxShadow: '1px 0 4px rgba(99,102,241,0.3)' },
  ...
  li: { lineHeight: '1.6', color: '#64748b', display: 'flex', gap: '8px' },
